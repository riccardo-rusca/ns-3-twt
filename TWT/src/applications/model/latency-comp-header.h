...
#ifndef LATENCY_COMP_HEADER_H
#define LATENCY_COMP_HEADER_H
 ...
 * The timestamp is set in Nanoseconds.
 *
 ...
 */
class LatencyCompHeader : public Header
{
  public:
    LatencyCompHeader();
     ...
     */
    Time GetTs() const;
    uint64_t GetNanosecondsTs() const;
