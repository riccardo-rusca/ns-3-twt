 ...
 */
#ifndef UDP_CLIENT_SERVER_11AX_HELPER_H
#define UDP_CLIENT_SERVER_11AX_HELPER_H
 ...
 */
class UdpMeasurementServerHelper
{
  public:
    /**
     * Create UdpMeasurementServerHelper which will make life easier for people trying
     * to set up simulations with udp-client-server-measurement application.
     *
     */
    UdpMeasurementServerHelper();
     ...
     */
    UdpMeasurementServerHelper(uint16_t port);
     ...
     */
    Ptr<UdpMeasurementServer> GetServer();

  private:
    ObjectFactory m_factory; //!< Object factory.
    Ptr<UdpMeasurementServer> m_server; //!< The last created server application
};
 ...
 *
 */
class UdpMeasurementClientHelper
{
  public:
    /**
     * Create UdpMeasurementClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server.
     *
     */
    UdpMeasurementClientHelper();
    ...
    UdpMeasurementClientHelper(Address ip, uint16_t port);
    /**
     *  Create UdpMeasurementClientHelper which will make life easier for people trying
     * to set up simulations with udp-client-server. Use this variant with
    ...
    UdpMeasurementClientHelper(Address addr);
...
#endif /* UDP_CLIENT_SERVER_11AX_HELPER_H */
